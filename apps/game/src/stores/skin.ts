...
export const SKINS: readonly SkinDef[] = [
	{id: 'prospector',    src: '/ship2.png',                          name: 'PROSPECTOR',    requiredStars: SKIN_STAR_THRESHOLDS['prospector'],    nozzle: {x: -2, y: 40}},
	{id: 'wanderer',      src: '/ship-skins/ship-wanderer.png',       name: 'WANDERER',      requiredStars: SKIN_STAR_THRESHOLDS['wanderer'],      nozzle: {x: -1, y: 38}},
	{id: 'engineer',      src: '/ship-skins/ship-engineer.png',       name: 'ENGINEER',      requiredStars: SKIN_STAR_THRESHOLDS['engineer'],      nozzle: {x: 0,  y: 36}},
	{id: 'veteran',       src: '/ship-skins/ship-veteran.png',        name: 'VETERAN',       requiredStars: SKIN_STAR_THRESHOLDS['veteran'],       nozzle: {x: 0,  y: 36}},
	{id: 'asteroid-king', src: '/ship-skins/ship-asteroid-king.png',  name: 'ASTEROID KING', requiredStars: SKIN_STAR_THRESHOLDS['asteroid-king'], nozzle: {x: 0,  y: 35}},
] as const;
