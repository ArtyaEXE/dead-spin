...
const UI_IMAGES = [
	...
	'/global-bg.jpg',
	'/main-menu-bg.png',
	'/result-screen-bg.png',
	'/screen-bold.png',
	'/screen-wide.png',
	'/star.png',
	'/booster-single.png',
	// Skins (скины ракеты — превьюшки в Shop + игровая ship-текстура)
	'/ship-skins/ship-wanderer.png',
	'/ship-skins/ship-engineer.png',
	'/ship-skins/ship-veteran.png',
	'/ship-skins/ship-asteroid-king.png',
	'/cave/ceres-outer.png',
	'/cave/ceres-inner.png',
	'/cave/pallas-outer.png',
	'/cave/pallas-inner.png',
	'/cave/juno-outer.png',
	'/cave/juno-inner.png',
	'/cave/vesta-outer.png',
	'/cave/vesta-inner.png',
	'/cave/eunomia-outer.png',
	'/cave/eunomia-inner.png',
...
const DECO_NAMES = [
	...
	'stuff-4.png',
	// CERES
	'ceres/ceres-stalactite.png',
	'ceres/ceres-crystal-cluster.png',
	'ceres/ceres-frozen-probe.png',
	'ceres/ceres-ice-sheet.png',
	'ceres/ceres-frost-pipe.png',
	'ceres/ceres-icicles.png',
];
