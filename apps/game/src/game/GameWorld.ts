...
export class GameWorld {
	...
	private draw(): void {
		...
		if (this.walls) {
			// Параллакс задней стены: чем выше коэффициент, тем меньше визуальный
			// лаг относительно мира. 0.85 → задний план двигается на 15% медленнее
			// переднего — пещера ощущается близко, а не "супер огромной".
