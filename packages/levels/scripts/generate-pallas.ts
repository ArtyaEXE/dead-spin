...
const SPECS: Spec[] = [
	...
	// ═══════════════════════ L18 — узкий вертикальный шахта ════════════
	{
		...
		startPoint: {x: 250, y: 200},
		finishPoint: {x: 850, y: 1800},
		stars: [
			{x: 360, y: 480},
			{x: 720, y: 1100},
			{x: 700, y: 1700},
	...
	// ═══════════════════════ L19 — первая мина ═════════════════════════
	{
		...
		startPoint: {x: 200, y: 700},
		finishPoint: {x: 1530, y: 950},
		stars: [
			{x: 470, y: 520},
			{x: 1300, y: 600},
			{x: 950, y: 130},
		],
		enemies: [{name: 'mine', x: 1000, y: 540, r: 0, radius: 30, speed: 0}],
		decor: [
	...
	// ═══════════════════════ L21 — миновое поле ═════════════════════════
	{
		...
		branches: [],
		rooms: [],
		startPoint: {x: 180, y: 550},
		finishPoint: {x: 1850, y: 550},
		stars: [
			{x: 500, y: 480},
			{x: 1080, y: 720},
			{x: 1750, y: 470},
	...
	// ═══════════════════════ L23 — два камня ════════════════════════════
	{
		...
		startPoint: {x: 200, y: 1100},
		finishPoint: {x: 1850, y: 350},
		stars: [
			{x: 470, y: 1000},
			{x: 1050, y: 580},
			{x: 1700, y: 430},
	...
	// ═══════════════════════ L26 — гравитация боковая ══════════════════
	{
		...
		startPoint: {x: 2050, y: 550},
		finishPoint: {x: 250, y: 550},
		stars: [
			{x: 1700, y: 360},
			{x: 950, y: 600},
			{x: 600, y: 660},
	...
	// ═══════════════════════ L27 — узкая шахта вниз с минами ═══════════
	{
		...
		branches: [],
		rooms: [],
		startPoint: {x: 280, y: 200},
		finishPoint: {x: 850, y: 2050},
		stars: [
			{x: 380, y: 500},
			{x: 600, y: 950},
			{x: 700, y: 1900},
	...
	// ═══════════════════════ L28 — gauntlet ═════════════════════════════
	{
		...
		startPoint: {x: 200, y: 750},
		finishPoint: {x: 2050, y: 750},
		stars: [
			{x: 600, y: 580},
			{x: 1100, y: 540},
			{x: 1600, y: 920},
	...
	// ═══════════════════════ L29 — первый червь ════════════════════════
	{
		...
		startPoint: {x: 200, y: 850},
		finishPoint: {x: 1850, y: 1500},
		stars: [
			{x: 550, y: 480},
			{x: 1300, y: 580},
			{x: 850, y: 1300},
	...
	// ═══════════════════════ L30 — PALLAS финал ════════════════════════
	{
		...
		rooms: [
			{x: 480, y: 1100, radius: 100},
			{x: 1500, y: 950, radius: 150},
		],
		startPoint: {x: 200, y: 200},
		finishPoint: {x: 2050, y: 1500},
		stars: [
			{x: 550, y: 350},
			{x: 480, y: 1100},
			{x: 1700, y: 1100},
...
for (const spec of SPECS) {
	...
	console.log(
		`L${spec.n}: ${json.res.x}×${json.res.y}  walls=${wp}pt  enemies=${json.enemies.length}  decor=${json.decorations.length}`,
	);
}
